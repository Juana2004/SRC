...
class Compatibilidad:
    """Clase utilitaria para verificar compatibilidades en donación de órganos."""
    
    @staticmethod
    def edad_es_compatible(edad_donante: int, edad_receptor: int) -> bool:
        """Verifica si las edades del donante y receptor son compatibles."""
        rangos = [
            ((0, 12), (0, 18)),
            ((13, 25), (10, 40)),
            ((26, 40), (15, 55)),
    ...
    def sangre_es_compatible(donante: object, receptor: object) -> bool:
        """Verifica si los tipos de sangre del donante y receptor son compatibles."""
        compatibilidad = {
            "O-": ["O-"],
            "O+": ["O-", "O+"],
            "A-": ["O-", "A-"],
    ...
    def organo_es_compatible(donante: object, organo_receptor: str) -> Optional[int]:
        """Busca si el donante tiene el órgano compatible y retorna su índice."""
